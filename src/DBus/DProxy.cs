...
// TODO(firox263): We do not support Proxy objects as Remoting
// has been removed from .NET Core. Investigate into alternatives
...
namespace DBus
{
    class UnsupportedProxyException : Exception
    {
        public UnsupportedProxyException()
            : base(@"System.Runtime.Remoting was removed in .NET
				Core. Proxies are currently unsupported. Please migrate
